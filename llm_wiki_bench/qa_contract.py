...
FINISH_TOOL = {
    ...
    "function": {
        "name": "finish_answer",
        "description": "Submit a short answer supported by read article passages, or unknown if evidence is unavailable. Validation errors allow further retrieval within budget. Requirement updates are applied before submission checks.",
        "parameters": {
            "type": "object",
            "properties": {
                "answer": {
...
QA_CONTROL_TOOLS = [
    {
        ...
        "function": {
            ...
            "description": "Record unresolved subquestions or support them with exact read article citations. This is a factual task state, not a reasoning transcript.",
            "parameters": {
